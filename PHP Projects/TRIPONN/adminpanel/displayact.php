<?php
	...
	$query="select * from $ptype where activity_id = '$actid';";
	$run=mysql_query($query);
	$hpdata=mysql_fetch_array($run);
	$actname=$hpdata["activity_name"];
	$actdate=$hpdata["activity_date"];
	$tnc=$hpdata["tnc"];
	$actdet=$hpdata["activity_details"];
	...
	echo "<tr><td>Activity Name</td><td>$actname</td></tr>";
	...
	echo "<tr><td>Package Name</td><td>$actname</td></tr>";
	echo "<tr><td>Start Date</td><td>$actdate</td></tr>";
	echo "<tr><td>Country</td><td>$country</td></tr>";
	echo "<tr><td>State</td><td>$state</td></tr>";
	echo "<tr><td>Area</td><td>$area</td></tr>";
	echo "<tr><td>Activity Details</td><td>$actdet</td></tr>";
	echo "</table>";
