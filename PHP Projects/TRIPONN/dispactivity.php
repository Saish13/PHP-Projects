<?php
	...
	echo $type=$_GET["type"];
	echo $id=$_GET["id"];
	$query="select * from $type where activity_id = '$id';";
	$run=mysql_query($query);
	$data=mysql_fetch_array($run);
	$pname=$data["activity_name"];
	$actd=$data["activity_date"];
	$tnc=$data["tnc"];
	$ad=$data["activity_details"];
...
<?php
	...
	echo "<p style='position:absolute;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BUY ACTIVITY</p>";
...
<tr><td>Activity Name</td><td><?php echo $pname; ?></td></tr>
<tr><td>Activity date</td><td><?php echo $actd; ?></td></tr>
...
<div id="pkdetails">
<h3><u>ACTIVITY ADDITIONAL DETAILS</u></h3>
<p><?php echo $ad ?></p>
</div>
<div id="tncdetails">
